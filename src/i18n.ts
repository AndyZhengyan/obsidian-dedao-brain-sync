const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.manualSync.section': '手动同步',
    'settings.sync.label': '手动同步',
    'settings.sync.desc': '一次性同步笔记到 vault',
    'settings.syncPicker.label': '选择性同步',
    'settings.syncPicker.desc': '先选择笔记，再同步',
    'settings.syncPicker.button': '选择性同步',
  ...
  en: {
    ...
    'settings.manualSync.section': 'Manual Sync',
    'settings.sync.label': 'Manual Sync',
    'settings.sync.desc': 'One-time sync all notes to vault',
