const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.prefix.placeholder': '例如 YYYYMMDD_HHmm',
    'settings.prefix.hint': '时间格式：YYYY / MM / DD / HH / mm（分）/ ss（秒）',
  ...
  en: {
    ...
    'settings.prefix.placeholder': 'e.g. YYYYMMDD_HHmm',
    'settings.prefix.hint': 'Time format: YYYY / MM / DD / HH / mm (minutes) / ss (seconds)',
