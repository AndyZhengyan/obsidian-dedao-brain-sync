export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.noteTypes.desc': '限制手动、定时和按笔记同步处理的笔记类型',
    'settings.noteTypes.hint': '全部勾选时等同于不限制类型',
  ...
  en: {
    ...
    'settings.noteTypes.desc': 'Limit which note types are processed by manual, scheduled, and note-based sync',
    'settings.noteTypes.hint': 'Selecting every type is treated as no type limit',
