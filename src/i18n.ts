export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.scheduled.syncKnowledgeBases': '同步知识库',
    'settings.scheduled.syncKnowledgeBases.hint': '勾选后开启跨库同步；不勾选 = 关闭跨库（仅同步当前账号笔记）',
    'settings.scheduled.syncKnowledgeBases.empty': '未选择（关闭跨库同步）',
    ...
    'settings.attachment.section': '附件导入',
  ...
  en: {
    ...
    'settings.scheduled.syncKnowledgeBases': 'Knowledge Bases',
    'settings.scheduled.syncKnowledgeBases.hint': 'Enable cross-KB sync by selecting one or more knowledge bases. Empty selection = cross-KB sync disabled (only notes in the current account are synced).',
    'settings.scheduled.syncKnowledgeBases.empty': 'None (cross-KB sync disabled)',
    ...
    'settings.attachment.section': 'Attachment Import',
