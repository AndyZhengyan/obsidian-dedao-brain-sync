export const translations: Record<string, Record<string, string>> = {
  zh: {
    ...
    'settings.quotaExhausted': '今日 OpenAPI 配额已消耗完毕，自动同步已暂停。配额定时重置（UTC+0 零点）。',
    'settings.quotaRetry': '配额可能已重置，运行手动同步即可恢复，自动同步将自动重启。',
  ...
  en: {
    ...
    'settings.quotaExhausted': 'OpenAPI quota exhausted for today. Auto-sync has been paused. Quota resets at UTC+0 midnight.',
    'settings.quotaRetry': 'Quota may have reset. Run a manual sync to restore auto-sync.',
