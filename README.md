...
- **版本基线重置**：本版本代码与 `1.4.4` 完全一致，仅将版本号推进到 `1.5.3`，并把仓库主线（main）重置回该稳定基线。此前 `1.5.0` / `1.5.1` 的功能变更已全部撤回，原始代码保留在 `archive/release-1.5.0-snapshot` 与 `archive/release-1.5.1-snapshot` 分支，随时可以恢复。
