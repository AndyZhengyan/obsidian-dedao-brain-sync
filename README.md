...
## 🎉 1.5.0 最新更新｜让同步少一点打断，让知识多一点沉淀

这是一次从“能同步”到“长期好用”的升级：把登录、续期、整理和排错中的琐碎动作交给插件，让得到大脑里的每一次记录，更安静、更可靠地沉淀进 Obsidian。

- **🪄 登录更轻松**：桌面端可在独立窗口中登录并自动获取 Web Token；会话未失效时，Token 过期也能后台续期并重试，减少同步被突然打断。
