...
- **版本号 bump**：本版本仅更新 `manifest.json` / `package.json` 中的版本号为 `1.5.2`，代码与 `1.4.4` 完全一致。之前 `1.5.0` / `1.5.1` 的功能变更被撤回，原始代码已保留在 `archive/release-1.5.0-snapshot` 与 `archive/release-1.5.1-snapshot` 分支，可随时取出。
